...
The file is a name used to look up optical properties from the consolidated `lap.npz` archive in `/data/OP_data/480band/`. The filename stem (without extension) is used as a key prefix. The available options are quite comprehensive, including:

- `bc_ChCB_rn40_dns1270.npz`:  uncoated black carbon (Bohren and Huffman, 1983)
- `miecot_slfsot_ChC90_dns_1317.npz`:  sulfate-coated BC (Bohren and Huffman, 1983)
- `brC_Kirch_BCsd.npz`:  uncoated brown carbon (Kirchstetter et al. (2004).)
- `brC_Kirch_BCsd_slfcot.npz`:  sulfate-coated brown carbon (Kirchstetter et al. (2004)
- `dust_balkanski_central_size1.npz`:  dust size 1 (r{'='}0.05-0.5um) (Balkanski et al 2007)
- `dust_balkanski_central_size2.npz`:  dust size 2 (r{'='}0.5-1.25um) (Balkanski et al 2007)
- `dust_balkanski_central_size3.npz`:  dust size 3 (r{'='}1.25-2.5um) (Balkanski et al 2007)
- `dust_balkanski_central_size4.npz`:  dust size 4 (r{'='}2.5-5.0um)  (Balkanski et al 2007)
- `dust_balkanski_central_size5.npz`:  dust size 5 (r{'='}5.0-50um)  (Balkanski et al 2007)
- `volc_ash_eyja_central_size1.npz`:  volcanic ash size 1 (r{'='}0.05-0.5um) (Flanner et al 2014)
- `volc_ash_eyja_central_size2.npz`:  volcanic ash size 2 (r{'='}0.5-1.25um) (Flanner et al 2014)
- `volc_ash_eyja_central_size3.npz`:  volcanic ash size 3 (r{'='}1.25-2.5um) (Flanner et al 2014)
- `volc_ash_eyja_central_size4.npz`:  volcanic ash size 4 (r{'='}2.5-5.0um) (Flanner et al 2014)
- `volc_ash_eyja_central_size5.npz`:  volcanic ash size 5 (r{'='}5.0-50um) (Flanner et al 2014)
- `volc_ash_mtsthelens_20081011.npz`:  ashes from Mount Saint Helen's
- `dust_skiles_size1.npz`:  Colorado dust 1 (Skiles et al 2017)
- `dust_skiles_size2.npz`:  Colorado dust 2 (Skiles et al 2017)
- `dust_skiles_size3.npz`:  Colorado dust 3 (Skiles et al 2017)
- `dust_skiles_size4.npz`:  Colorado dust 4 (Skiles et al 2017)
- `dust_skiles_size5.npz`:  Colorado dust 5 (Skiles et al 2017)
- `dust_greenland_central_size1.npz`:  Greenland dust 1 (Polashenski et al 2015)
- `dust_greenland_central_size2.npz`:  Greenland dust 2 (Polashenski et al 2015)
- `dust_greenland_central_size3.npz`:  Greenland dust 3 (Polashenski et al 2015)
- `dust_greenland_central_size4.npz`:  Greenland dust 4 (Polashenski et al 2015)
- `dust_greenland_central_size5.npz`:  Greenland dust 5 (Polashenski et al 2015)
- `dust_greenland_Cook_LOW_20190911.npz`:  Dark Zone dust 1 (Cook et al. 2019 "LOW")
- `dust_greenland_Cook_CENTRAL_20190911.npz`:  Dark Zone dust 2 (Cook et al. 2019 "MEAN")
- `dust_greenland_Cook_HIGH_20190911.npz`:  Dark Zone dust 3 (Cook et al. 2019 "HIGH")
- `snw_alg_r025um_chla020_chlb025_cara150_carb140.npz`:  Snow Algae (Cook et al. 2017a, spherical, C nivalis)
- `snow_algae_empirical_Chevrollier2023.npz`:  Snow algae, whole-cell measurements (Chevrollier et al 2023, 2024)
- `Cook2020_glacier_algae_4_40.npz`:  Glacier algae, reconstructed from pigment profiles (Cook et al. 2020)
- `ice_algae_empirical_Chevrollier2023.npz`:  Glacier algae, whole-cell measurements (Chevrollier et al 2023, 2024)
  
  
### UNIT

All these impurities have their mass absorption coefficients in units of ppb, and therefore their concentration (CONC) should be expressed normalised to mass in the model - i.e. in ng/g or ppb. This is achieved by setting `UNIT {'=='}0`. There are two exceptions to this:  "snow_algae_empirical_Chevrollier2023.npz" and "ice_algae_empirical_Chevrollier2023.npz". These are empirically measured optical properties for snow and glacier algae whose absorption coefficients is expressed in m2/cell. Their concentration (`CONC`) should therefore be expressed in cells/mL. This is achieved by setting `UNIT{'=='}1`. There are validity checks in place to ensure these values are set correctly.
...
Toggles saving of new optical property data into the consolidated `lap.npz` archive used by biosnicar.
...
Stem name used as the key prefix when saving new impurity optical properties into `lap.npz`. For example, a stem of `"my_algae"` will create entries like `my_algae__ext_cff_mss`, `my_algae__ss_alb`, etc. This stem should match the filename (without extension) defined in the `FILE` field of any `Impurity` that will use these optical properties.
...
Any additional information to be stored as metadata alongside the saved optical properties (e.g. authors, dates etc).
