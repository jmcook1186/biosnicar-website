...
However, we also provide a `biooptical` module (in `biosnicar/biooptical/`) that includes a model to calculate the single-scattering optical properties of pigmented algae, given user defined shape and pigment concentrations.
